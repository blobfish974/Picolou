...
class BarItem extends React.Component {
  ...
  render() {
    ...
    const { bar } = this.props // <==> const film = this.props.film & const displayDetailForFilm = this.props.displayDetailForFilm
    return (
        <TouchableOpacity 
          ...
          <View style={styles.content_container}>
            ...
            <View style={styles.description_container}>
              <Text style={styles.description_text} numberOfLines={6}>{bar.address}</Text>
            </View>
          </View>
        </TouchableOpacity>
      )
